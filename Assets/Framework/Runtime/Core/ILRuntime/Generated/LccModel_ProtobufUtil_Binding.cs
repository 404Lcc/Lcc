...
{
    unsafe class LccModel_ProtobufUtil_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(LccModel.ProtobufUtil);
        ...
        static StackObject* Deserialize_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LccModel.ProtobufUtil.Deserialize(@type, @bytes, @index, @count);
