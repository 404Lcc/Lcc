...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            LccModel_IdleState_Binding.Register(app);
            LccModel_AIComponent_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_String_LoadHandler_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_LoadHandler_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_LoadHandler_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            BM_LoadHandlerBase_Binding.Register(app);
            LccModel_AssetManager_Binding.Register(app);
            BM_LoadHandler_Binding.Register(app);
            ...
            ET_ETTask_1_LoadHandler_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_String_FieldInfo_Binding.Register(app);
            System_Collections_Generic_List_1_Canvas_Binding.Register(app);
