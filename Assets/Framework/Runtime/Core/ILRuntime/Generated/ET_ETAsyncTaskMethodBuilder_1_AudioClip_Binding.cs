...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETAsyncTaskMethodBuilder_1_AudioClip_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(ET.ETTask<UnityEngine.AudioClip>), typeof(LccModel.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ET.ETTask<UnityEngine.AudioClip>).MakeByRefType(), typeof(LccModel.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ET.ETAsyncTaskMethodBuilder<UnityEngine.AudioClip> instance_of_this_method)
        {
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ((ET.ETAsyncTaskMethodBuilder<UnityEngine.AudioClip>)instance_of_this_method).Start<LccModel.IAsyncStateMachineAdapter.Adapter>(ref @stateMachine);
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<ET.ETTask<UnityEngine.AudioClip>, LccModel.IAsyncStateMachineAdapter.Adapter>(ref @awaiter, ref @stateMachine);
