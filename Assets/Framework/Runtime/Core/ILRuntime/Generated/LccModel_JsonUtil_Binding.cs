...
{
    unsafe class LccModel_JsonUtil_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(LccModel.JsonUtil);
        ...
        static StackObject* ToObject_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LccModel.JsonUtil.ToObject<ILRuntime.Runtime.Intepreter.ILTypeInstance>(@json);
        ...
        static StackObject* ToJson_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LccModel.JsonUtil.ToJson(@obj);
