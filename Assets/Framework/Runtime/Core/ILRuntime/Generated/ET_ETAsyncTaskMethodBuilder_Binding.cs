...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETAsyncTaskMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(ET.ETTask<YooAsset.AssetHandle>), typeof(LccModel.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ET.ETTask<YooAsset.AssetHandle>).MakeByRefType(), typeof(LccModel.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ET.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>), typeof(LccModel.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ET.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>).MakeByRefType(), typeof(LccModel.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref ET.ETAsyncTaskMethodBuilder instance_of_this_method)
        {
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ((ET.ETAsyncTaskMethodBuilder)instance_of_this_method).Start<LccModel.IAsyncStateMachineAdapter.Adapter>(ref @stateMachine);
        ...
        static StackObject* AwaitUnsafeOnCompleted_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ET.ETTask<YooAsset.AssetHandle> @awaiter = (ET.ETTask<YooAsset.AssetHandle>)typeof(ET.ETTask<YooAsset.AssetHandle>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ET.ETAsyncTaskMethodBuilder instance_of_this_method = (ET.ETAsyncTaskMethodBuilder)typeof(ET.ETAsyncTaskMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            instance_of_this_method.AwaitUnsafeOnCompleted<ET.ETTask<YooAsset.AssetHandle>, LccModel.IAsyncStateMachineAdapter.Adapter>(ref @awaiter, ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ET.ETTask<YooAsset.AssetHandle>[];
                        instance_of_arrayReference[ptr_of_this_method->ValueLow] = @awaiter;
                    }
                    break;
            }
        ...
        static StackObject* AwaitUnsafeOnCompleted_8(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<ET.ETTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>, LccModel.IAsyncStateMachineAdapter.Adapter>(ref @awaiter, ref @stateMachine);
