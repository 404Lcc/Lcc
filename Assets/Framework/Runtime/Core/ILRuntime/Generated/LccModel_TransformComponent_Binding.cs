...
{
    unsafe class LccModel_TransformComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(LccModel.TransformComponent);
            args = new Type[]{};
        ...
        static StackObject* get_position_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            LccModel.TransformComponent instance_of_this_method = (LccModel.TransformComponent)typeof(LccModel.TransformComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
