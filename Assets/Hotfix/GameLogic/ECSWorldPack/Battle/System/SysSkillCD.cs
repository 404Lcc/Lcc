...
namespace LccHotfix
{
    public class SysSkillCD : IExecuteSystem
    {
        ...
        {
            _group = world.LogicContext.GetGroup(LogicMatcher.AllOf(LogicComponentsLookup.ComSkills, LogicComponentsLookup.ComProperty, LogicComponentsLookup.ComTransform));
        }
