...
namespace LccHotfix
{
    //全特性标记
    [Serializable]
    public class PlayerFeaturesContext
    {
        // 全局增伤
        ...
        public float DeathScytheHitHealPercent; // 攻击吸血：回复伤害百分比（灵魂挥镰Ⅲ=5%，Combo=1%；命中 5% 触发）
        ...
        public int GroundSpikeLevel; // 当前等级 1~5，层数/吸血比例由等级派生（概率固定 20%）
	   ...
	   // 通用流星雨：队长累计移动距离触发，周围随机敌人单体落星
        ...
        public float GroundSpikeLifeStealRate; // Combo 额外吸血：地刺吸血比例，0=用等级默认（Ⅰ 2% / Ⅴ 3% / Combo 4%）
