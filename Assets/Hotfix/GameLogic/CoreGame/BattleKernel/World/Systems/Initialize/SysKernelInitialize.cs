...
namespace LccHotfix
{
    public class SysKernelInitialize : SysBase, IInitializeSystem
    {
        ...
        private void InitEntityIndex()
        {
            ...
            logicWorld.AddEntityIndex(new EntityIndex<LogicEntity, EFaction>(EntityIndexName.FactionFighter, fighterGroup, (e, c) => c is FactionComponent fc ? fc.Faction : e.comFaction.Faction));
            ...
            logicWorld.AddEntityIndex(new EntityIndex<LogicEntity, int>(EntityIndexName.BattleUnitTagComponent, logicWorld.GetGroup(LogicMatcher.AllOf(LogicComponentsLookup.ComBattleUnitTag)), (e, c) => ((BattleUnitTagComponent)c).Tag.BattleUnitId ?? 0));
