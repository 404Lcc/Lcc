...
namespace LccHotfix
{
    ...
    public static class LogicEntityViewExtensions
    {
        ...
        /// <summary>
        /// 取 entity 上首个 IMainAnimatorView 提供的 Animator。地图对象或动态视图均可。
        /// </summary>
        public static Animator MainAnimator(this LogicEntity entity)
        {
            if (!entity.hasComView) return null;
            foreach (var wrapper in entity.comView.ViewList)
            {
