...
namespace LccHotfix
{
    public partial class MetaWorld : Context<MetaEntity>
    {
        ...
        public MetaWorld(ContextInfo contextInfo, int totalComponents, Func<MetaEntity> entityFactory, int startCreationIndex = 0, Func<Entity, IAERC> aercFactory = null) : base(totalComponents, startCreationIndex, contextInfo, aercFactory, entityFactory)
        {
