    ...
    public class Manager : Singleton<Manager>
    {
        public override void Update()
        {
            ...
            if (Application.platform == RuntimePlatform.WindowsEditor)
            {
                ...
                {
                    ScreenCapture.CaptureScreenshot(Util.GetPath(PathType.PersistentDataPath, "Res") + "Screenshot.png");
                }
            }
        }
        /// <summary>
        ...
        public void InitUserSet()
        {
            ...
            {
                Util.SetResolution(true, width, height);
            }
            else if (UserSetData.displayModeType == DisplayModeType.Window)
            {
                Util.SetResolution(false, width, height);
            }
