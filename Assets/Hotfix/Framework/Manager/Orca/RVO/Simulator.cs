...
namespace RVO
{
    ...
    public class Simulator
    {
         ...
         * agent.</param>
         */
        public Agent addAgent(Vector2 position)
        {
         ...
         * </remarks>
         */
        public ObstaclePolygon addObstacle(IList<Vector2> vertices)
        {
            if (vertices.Count < 2)
            {
                return null;
        ...
        internal void reBuildObstacle()
        {
            if (obstacleChange)
            {
                ...
                for (int polygonIndex = 0; polygonIndex < obstaclePolygons_.Count; polygonIndex++)
                {
                    ...
                    IList<Vector2> vertices = obstaclePolygons_[polygonIndex]._vertices;
                    for (int i = 0; i < vertices.Count; ++i)
                    {
        ...
        /**
         * <summary>执行仿真步骤，更新每个agent的二维位置和二维速度。
        ...
        /**
         * <summary>返回多边形中在指定障碍顶点之前的障碍顶点的编号。
         ...
         * obstacle vertex in its polygon.</returns>
         *
         * <param name="vertexNo">要检索其前任的障碍顶点的编号。
         ...
         * 这个数字越大，模拟的运行时间就越长。如果数值过低，模拟将不安全。必须是非负的。
         ...
         * <param name="timeHorizon">由模拟计算的新代理的速度相对于其他代理安全的默认最小时间量。
         * 这个数字越大，智能体对其他智能体的反应就越快，但智能体选择速度的自由就越少。肯定是积极的。
         ...
         * positive.</param>
         * <param name="timeHorizonObst">由模拟计算的新代理的速度相对于障碍物安全的默认最小时间量。
         * 这个数字越大，智能体对障碍的反应就越快，但智能体选择速度的自由就越少。肯定是积极的。
         * The default minimal amount of time for
         * which a new agent's velocities that are computed by the simulation
        ...
        /**
         * <summary>设置指定代理的最大速度
         * Sets the maximum speed of a specified agent.</summary>
         *
         * <param name="agentNo">The number of the agent whose maximum speed is
        ...
        /**
         * <summary>设置指定代理的半径。
         * Sets the radius of a specified agent.</summary>
         *
         * <param name="agentNo">The number of the agent whose radius is to be
         * modified.</param>
        ...
        /**
         * <summary>设置模拟的全局时间。
         * Sets the global time of the simulation.</summary>
         *
        ...
        /**
         * <summary>设置工人的数量
         * Sets the number of workers.</summary>
         *
        ...
        /**
         * <summary>设置模拟的时间步长。
         * Sets the time step of the simulation.</summary>
         *
