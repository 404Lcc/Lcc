...
namespace Model
{
    public class LogManager : MonoBehaviour
    {
        ...
        public LogInfo CreateLog(LogType type, string log)
        {
            ...
            info.container = IO.containerManager.CreateContainer(GameUtil.ConvertLogTypeToString(type), false);
            info.type = type;
        ...
        public void ClearLog(LogType type)
        {
            if (LogExist(type))
            {
                IO.containerManager.RemoveContainer(GameUtil.ConvertLogTypeToString(type));
