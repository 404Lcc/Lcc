...
namespace LccModel
{
    public static class EntityFactory
    {
        ...
        public static AObjectBase Create<P1>(Type type, P1 p1, params object[] datas)
        {
            AObjectBase aObjectBase = (AObjectBase)Activator.CreateInstance(type);
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static AObjectBase Create<P1, P2>(Type type, P1 p1, P2 p2, params object[] datas)
        {
            AObjectBase aObjectBase = (AObjectBase)Activator.CreateInstance(type);
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static AObjectBase Create<P1, P2, P3>(Type type, P1 p1, P2 p2, P3 p3, params object[] datas)
        {
            AObjectBase aObjectBase = (AObjectBase)Activator.CreateInstance(type);
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static AObjectBase Create<P1, P2, P3, P4>(Type type, P1 p1, P2 p2, P3 p3, P4 p4, params object[] datas)
        {
            AObjectBase aObjectBase = (AObjectBase)Activator.CreateInstance(type);
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static T Create<T, P1>(P1 p1, params object[] datas) where T : AObjectBase
        {
            T aObjectBase = Activator.CreateInstance<T>();
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static T Create<T, P1, P2>(P1 p1, P2 p2, params object[] datas) where T : AObjectBase
        {
            T aObjectBase = Activator.CreateInstance<T>();
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static T Create<T, P1, P2, P3>(P1 p1, P2 p2, P3 p3, params object[] datas) where T : AObjectBase
        {
            T aObjectBase = Activator.CreateInstance<T>();
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
        ...
        public static T Create<T, P1, P2, P3, P4>(P1 p1, P2 p2, P3 p3, P4 p4, params object[] datas) where T : AObjectBase
        {
            T aObjectBase = Activator.CreateInstance<T>();
            aObjectBase.id = IdUtil.Generate();
            ObjectBaseEventSystem.Instance.Register(aObjectBase);
