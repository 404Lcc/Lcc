...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Runtime_CompilerServices_AsyncVoidMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Runtime.CompilerServices.TaskAwaiter), typeof(LccModel.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Runtime.CompilerServices.TaskAwaiter).MakeByRefType(), typeof(LccModel.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            LccModel.IAsyncStateMachineAdapter.Adapter @stateMachine = (LccModel.IAsyncStateMachineAdapter.Adapter)typeof(LccModel.IAsyncStateMachineAdapter.Adapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            ((System.Runtime.CompilerServices.AsyncVoidMethodBuilder)instance_of_this_method).Start<LccModel.IAsyncStateMachineAdapter.Adapter>(ref @stateMachine);
        ...
        static StackObject* AwaitUnsafeOnCompleted_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<System.Runtime.CompilerServices.TaskAwaiter, LccModel.IAsyncStateMachineAdapter.Adapter>(ref @awaiter, ref @stateMachine);
