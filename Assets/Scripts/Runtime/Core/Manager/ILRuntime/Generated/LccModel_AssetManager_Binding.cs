    ...
    unsafe class LccModel_AssetManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("LoadAsset", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(UnityEngine.TextAsset), typeof(System.String), typeof(System.String), typeof(System.Boolean), typeof(System.Boolean), typeof(System.String[])))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* LoadAsset_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.LoadAsset<UnityEngine.TextAsset>(@name, @suffix, @isKeep, @isAssetBundle, @types);
