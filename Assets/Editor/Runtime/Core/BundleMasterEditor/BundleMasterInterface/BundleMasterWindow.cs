...
namespace BM
{
    ...
    public partial class BundleMasterWindow : EditorWindow
    {
        ...
        /// 分包文件资源索引配置
        /// </summary>
        public static string AssetLoadTablePath = "Assets/Editor/Runtime/Core/BundleMasterEditor/BuildSettings/AssetLoadTable.asset";

        /// <summary>
        /// 分包配置信息
        /// </summary>
        public static string AssetsLoadSettingPath = "Assets/Editor/Runtime/Core/BundleMasterEditor/BuildSettings/AssetsLoadSetting";
        
        /// <summary>
        /// 原生资源包配置信息
        /// </summary>
        public static string AssetsOriginSettingPath = "Assets/Editor/Runtime/Core/BundleMasterEditor/BuildSettings/AssetsOriginSetting";
