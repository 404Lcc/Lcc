    ...
    public class ILRuntimeEditorWindow : AEditorWindowBase
    {
        ...
        public void BuildCLRBinding()
        {
            ...
            using (MemoryStream dll = new MemoryStream(RijndaelUtil.RijndaelDecrypt("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", FileUtil.GetAsset("Assets/Bundles/DLL/Unity.Hotfix.dll.bytes"))))
            {
                ...
                BindingCodeGenerator.GenerateBindingCode(appDomain, "Assets/Framework/Runtime/Core/ILRuntime/Generated");
            }
        ...
        public void BuildCrossBinding()
        {
            ...
            if (File.Exists($"Assets/Framework/Runtime/Core/ILRuntime/Adapter/{className}Adapter.cs"))
            {
                File.Delete($"Assets/Framework/Runtime/Core/ILRuntime/Adapter/{className}Adapter.cs");
            }
            FileUtil.SaveAsset($"Assets/Framework/Runtime/Core/ILRuntime/Adapter/{className}Adapter.cs", CrossBindingCodeGenerator.GenerateCrossBindingAdapterCode(type, "LccModel"));
            AssetDatabase.Refresh();
        }
    }
}